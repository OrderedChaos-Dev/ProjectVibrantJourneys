...
public record FallenTreeConfiguration(BlockState hollowLog, BlockState baseLog, List<WeightedBiomeEntry> data) implements FeatureConfiguration {
	   ...
	   public static final Codec<FallenTreeConfiguration> CODEC = RecordCodecBuilder.create((builder) -> {
		   return builder.group(
				   ...
				   TreeFeatureUtils.WeightedBiomeEntry.CODEC.listOf().fieldOf("data").forGetter(FallenTreeConfiguration::data)

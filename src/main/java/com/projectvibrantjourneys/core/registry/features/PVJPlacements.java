...
public class PVJPlacements {
	...
	public static final RegistryObject<PlacedFeature> OAK_FALLEN_TREE = register("oak_fallen_tree", PVJConfiguredFeatures.OAK_FALLEN_TREE, VegetationPlacements.worldSurfaceSquaredWithCount(1));
	public static final RegistryObject<PlacedFeature> BIRCH_FALLEN_TREE = register("birch_fallen_tree", PVJConfiguredFeatures.BIRCH_FALLEN_TREE, VegetationPlacements.worldSurfaceSquaredWithCount(1));
	public static final RegistryObject<PlacedFeature> SPRUCE_FALLEN_TREE = register("spruce_fallen_tree", PVJConfiguredFeatures.SPRUCE_FALLEN_TREE, VegetationPlacements.worldSurfaceSquaredWithCount(1));
	public static final RegistryObject<PlacedFeature> JUNGLE_FALLEN_TREE = register("jungle_fallen_tree", PVJConfiguredFeatures.JUNGLE_FALLEN_TREE, VegetationPlacements.worldSurfaceSquaredWithCount(1));
	public static final RegistryObject<PlacedFeature> ACACIA_FALLEN_TREE = register("acacia_fallen_tree", PVJConfiguredFeatures.ACACIA_FALLEN_TREE, VegetationPlacements.worldSurfaceSquaredWithCount(1));
	public static final RegistryObject<PlacedFeature> DARK_OAK_FALLEN_TREE = register("dark_oak_fallen_tree", PVJConfiguredFeatures.DARK_OAK_FALLEN_TREE, VegetationPlacements.worldSurfaceSquaredWithCount(1));

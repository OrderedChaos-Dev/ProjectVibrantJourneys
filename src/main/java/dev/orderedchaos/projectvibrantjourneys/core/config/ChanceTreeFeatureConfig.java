...
public class ChanceTreeFeatureConfig {
  ...
  public static final Set<ChanceBiomeEntry> CHERRY_DEFAULT = Set.of(entry("minecraft:cherry_grove", 20));
  public static final Set<ChanceBiomeEntry> MANGROVE_DEFAULT = Set.of(entry("minecraft:mangrove_swamp", 20));

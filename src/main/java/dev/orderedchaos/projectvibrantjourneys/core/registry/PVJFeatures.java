...
public class PVJFeatures {
  ...
  public static final RegistryObject<Feature<RandomPatchConfiguration>> GROUNDCOVER = registerFeature("groundcover", new RocksGroundcoverFeature(RandomPatchConfiguration.CODEC));

...
public class DirectionalStateProvider extends BlockStateProvider {
  public static final MapCodec<DirectionalStateProvider> CODEC = BlockState.CODEC.fieldOf("state").xmap(BlockBehaviour.BlockStateBase::getBlock, Block::defaultBlockState).xmap(DirectionalStateProvider::new, (p_68793_) -> {

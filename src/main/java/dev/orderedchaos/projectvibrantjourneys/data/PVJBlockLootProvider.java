...
public class PVJBlockLootProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropSelf(PVJBlocks.OAK_HOLLOW_LOG.get());
        dropSelf(PVJBlocks.BIRCH_HOLLOW_LOG.get());
        dropSelf(PVJBlocks.SPRUCE_HOLLOW_LOG.get());
        dropSelf(PVJBlocks.JUNGLE_HOLLOW_LOG.get());
        dropSelf(PVJBlocks.ACACIA_HOLLOW_LOG.get());
        dropSelf(PVJBlocks.DARK_OAK_HOLLOW_LOG.get());

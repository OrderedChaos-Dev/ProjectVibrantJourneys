...
public class BlockShortGrass extends BlockBush implements IGrowable, IShearable, IPropertyHelper
{
	...
	private EnumGrassType type;
	
	public BlockShortGrass(EnumGrassType type)
	{
        super(Material.VINE);
        this.type = type;
    ...
    public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, @Nullable TileEntity te, ItemStack stack)
    {
        if (!worldIn.isRemote && stack.getItem() == Items.SHEARS)
        {
            ...
            spawnAsEntity(worldIn, pos, new ItemStack(Blocks.TALLGRASS, 1, 0));
        }
        else
        {
    ...
    {
        return type != EnumGrassType.DEAD;
    }

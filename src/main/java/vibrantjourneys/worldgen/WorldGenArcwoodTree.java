...
public class WorldGenArcwoodTree extends WorldGenAbstractTree
{
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<WorldGenArcwoodTree.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new WorldGenArcwoodTree.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new WorldGenArcwoodTree.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeaves()
    {
        for (WorldGenArcwoodTree.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords)
        {

...
public class ModelPVJBoat extends ModelBase implements IMultipassModel
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        EntityPVJBoat entityboat = (EntityPVJBoat)entityIn;
    ...
    protected void renderPaddle(EntityPVJBoat boat, int paddle, float scale, float limbSwing)
    {

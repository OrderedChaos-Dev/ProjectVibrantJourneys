...
public class LayerSmallSpiderEyes<T extends EntitySmallSpider> implements LayerRenderer<T>
{
    private static final ResourceLocation SPIDER_EYES = new ResourceLocation("textures/entity/spider_eyes.png");
    private final RenderSmallSpider<T> spiderRenderer;

    public LayerSmallSpiderEyes(RenderSmallSpider<T> spiderRendererIn)
    {

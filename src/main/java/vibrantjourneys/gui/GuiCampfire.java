...
public class GuiCampfire extends GuiContainer
{
    ...
    public GuiCampfire(InventoryPlayer playerInv, IInventory campfire)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        if (TileEntityCampfire.isBurning(this.campfire))
        {
    ...
    {
        int i = this.campfire.getField(2);

...
public class ConfigDefaults {
	...
	public static void load() {
		...
		//jungle
		addTo("minecraft:jungle", JUNGLE_TREES, ROCKS, BONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS, TROPICAL_FISH);
		...
		addTo("minecraft:jungle_edge", JUNGLE_TREES_SPARSE, ROCKS, BONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS, TROPICAL_FISH);
		addTo("minecraft:modified_jungle", JUNGLE_TREES, ROCKS, BONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS, TROPICAL_FISH);
		addTo("minecraft:modified_jungle_edge", JUNGLE_TREES_SPARSE, ROCKS, BONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS, TROPICAL_FISH);
		addTo("minecraft:bamboo_jungle", JUNGLE_TREES, ROCKS, BONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS, TROPICAL_FISH);
		...
		//modded
		addTo("projectvibrantjourneys:overgrown_spires", OAK_TREES_SPARSE, JUNGLE_TREES, DARK_OAK_TREES, ROCKS, BONES, LILYPAD, FROGBIT, DUCKWEED, BUSH, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS, TROPICAL_FISH);

...
public class ConfigDefaults {
	...
	public static void load() {
		...
		//plains
		addTo("minecraft:plains", OAK_TWIGS_SPARSE, ROCKS, BONES, BUSH, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, HAUNT, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:sunflower_plains", OAK_TWIGS_SPARSE, ROCKS, BONES, BUSH, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, HAUNT, FLY, FIREFLY, CATTAIL);
		
		//forest
		addTo("minecraft:forest", OAK_TWIGS, BIRCH_TWIGS_SPARSE, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:wooded_hills", OAK_TWIGS, BIRCH_TWIGS_SPARSE, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:flower_forest", OAK_TWIGS, BIRCH_TWIGS_SPARSE, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, CATTAIL);
		
		//birch forest
		addTo("minecraft:birch_forest", BIRCH_TWIGS, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:birch_forest_hills", BIRCH_TWIGS, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:tall_birch_forest", BIRCH_TWIGS, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:tall_birch_hills", BIRCH_TWIGS, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, CATTAIL);
		
		//dark forest
		addTo("minecraft:dark_forest", OAK_TWIGS_SPARSE, DARK_OAK_TWIGS, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:dark_forest_hills", OAK_TWIGS_SPARSE, DARK_OAK_TWIGS, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL);
		
		//swamp
		addTo("minecraft:swamp", OAK_TWIGS, ROCKS, BONES, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:swamp_hills", OAK_TWIGS, ROCKS, BONES, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL);
		
		//taiga
		addTo("minecraft:taiga", SPRUCE_TWIGS, ROCKS, BONES, PINECONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, CATTAIL);
		...
		addTo("minecraft:giant_tree_taiga", SPRUCE_TWIGS, ROCKS, BONES, PINECONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, CATTAIL);
		...
		addTo("minecraft:giant_spruce_taiga", SPRUCE_TWIGS, ROCKS, BONES, PINECONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, CATTAIL);
		...
		//jungle
		addTo("minecraft:jungle", JUNGLE_TWIGS, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:jungle_hills", JUNGLE_TWIGS, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:jungle_edge", JUNGLE_TWIGS_SPARSE, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:modified_jungle", JUNGLE_TWIGS, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:modified_jungle_edge", JUNGLE_TWIGS_SPARSE, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:bamboo_jungle", JUNGLE_TWIGS, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL);
		addTo("minecraft:bamboo_jungle_hills", JUNGLE_TWIGS, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, CATTAIL);
		
		//river
		addTo("minecraft:river", ROCKS, ROCKS, BONES, LILYPAD, IRON_NUGGET, GOLD_NUGGET, FLINT, SKELETAL_KNIGHT, GHOST, FLY, FIREFLY, CATTAIL);

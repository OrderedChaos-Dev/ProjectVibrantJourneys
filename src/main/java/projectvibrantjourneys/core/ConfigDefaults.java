...
public class ConfigDefaults {
	...
	public static void load() {
		...
		//swamp
		addTo("minecraft:swamp", OAK_TREES, MANGROVE_TREES_SPARSE, ROCKS, BONES, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, SNAIL, SLUG, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS);
		...
		//jungle
		addTo("minecraft:jungle", PALM_TREES, MANGROVE_TREES_SPARSE, JUNGLE_TREES, ROCKS, BONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, SNAIL, SLUG, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS, TROPICAL_FISH);
		...
		addTo("minecraft:modified_jungle", PALM_TREES, MANGROVE_TREES_SPARSE, JUNGLE_TREES, ROCKS, BONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, SNAIL, SLUG, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS, TROPICAL_FISH);
		...
		addTo("minecraft:bamboo_jungle", MANGROVE_TREES_SPARSE, PALM_TREES, JUNGLE_TREES, ROCKS, BONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SHADE, FLY, FIREFLY, SNAIL, SLUG, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS, TROPICAL_FISH);

...
public class ConfigDefaults {
	...
	public static final List<String> ASPEN_TREES = new ArrayList<String>();
	public static final List<String> ASPEN_TREES_SPARSE = new ArrayList<String>();
	public static final List<String> RED_MAPLE_TREES = new ArrayList<String>();
	public static final List<String> RED_MAPLE_TREES_SPARSE = new ArrayList<String>();
	public static final List<String> ORANGE_MAPLE_TREES = new ArrayList<String>();
	...
	public static final List<String> SMALL_SPIDER = new ArrayList<String>();
	...
	public static void load() {
		...
		//taiga
		addTo("minecraft:taiga", SPRUCE_TREES, ROCKS, BONES, PINECONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, SMALL_SPIDER, SNAIL, SLUG, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SEAGRASS);
		addTo("minecraft:taiga_hills", SPRUCE_TREES, ROCKS, BONES, PINECONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, SMALL_SPIDER, SNAIL, SLUG, BARK_MUSHROOM, COBWEB, CLAM, SEAGRASS);
		...
		addTo("minecraft:giant_tree_taiga", SPRUCE_TREES, ROCKS, BONES, PINECONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, SMALL_SPIDER, SNAIL, SLUG, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SEAGRASS);
		addTo("minecraft:giant_tree_taiga_hills", SPRUCE_TREES, ROCKS, BONES, PINECONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, SMALL_SPIDER, SNAIL, SLUG, BARK_MUSHROOM, COBWEB, CLAM, SEAGRASS);
		addTo("minecraft:taiga_mountains", SPRUCE_TREES, ROCKS, BONES, PINECONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, SMALL_SPIDER, SNAIL, SLUG, BARK_MUSHROOM, COBWEB, CLAM, SEAGRASS);
		...
		addTo("minecraft:giant_spruce_taiga", SPRUCE_TREES, ROCKS, BONES, PINECONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, SMALL_SPIDER, SNAIL, SLUG, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SEAGRASS);
		addTo("minecraft:giant_spruce_taiga_hills", SPRUCE_TREES, ROCKS, BONES, PINECONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, SMALL_SPIDER, SNAIL, SLUG, BARK_MUSHROOM, COBWEB, CLAM, SEAGRASS);
		...
		addTo("projectvibrantjourneys:boreal_forest", FIR_TREES, PINE_TREES, ROCKS, BONES, PINECONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, SMALL_SPIDER, SNAIL, SLUG, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS);
		addTo("projectvibrantjourneys:snowy_boreal_forest", FIR_TREES, PINE_TREES, ROCKS, ICE_CHUNKS, BONES, PINECONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, SKELETAL_KNIGHT, GHOST, BANSHEE, FLY, FIREFLY, SMALL_SPIDER, SNAIL, SLUG, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS);
		addTo("projectvibrantjourneys:boreal_plateau", FIR_TREES, PINE_TREES, ROCKS, ICE_CHUNKS, BONES, PINECONES, LILYPAD, FROGBIT, DUCKWEED, IRON_NUGGET, GOLD_NUGGET, FLINT, SKELETAL_KNIGHT, GHOST, BANSHEE, FLY, FIREFLY, SMALL_SPIDER, SNAIL, SLUG, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS);
		...
		addTo("projectvibrantjourneys:redwoods", REDWOOD_TREES, ROCKS, BONES, PINECONES, FROGBIT, DUCKWEED, BUSH, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, SMALL_SPIDER, SNAIL, SLUG, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS);
		addTo("projectvibrantjourneys:redwood_peaks", REDWOOD_TREES, ROCKS, BONES, PINECONES, LILYPAD, FROGBIT, DUCKWEED, BUSH, IRON_NUGGET, GOLD_NUGGET, FLINT, DUNG, SKELETAL_KNIGHT, GHOST, SPECTER, FLY, FIREFLY, SMALL_SPIDER, SNAIL, SLUG, CATTAIL, BARK_MUSHROOM, COBWEB, CLAM, SHORT_GRASS, SEAGRASS);

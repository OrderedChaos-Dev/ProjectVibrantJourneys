...
import projectvibrantjourneys.common.world.placers.RocksPlacer;
import projectvibrantjourneys.core.PVJConfig;

public class PVJFeatures {
	
	public static void init() {
		BlockClusterFeatureConfig oakTwigsCluster = createGroundcoverConfig(PVJBlocks.oak_twigs.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig birchTwigsCluster = createGroundcoverConfig(PVJBlocks.birch_twigs.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig spruceTwigsCluster = createGroundcoverConfig(PVJBlocks.spruce_twigs.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig jungleTwigsCluster = createGroundcoverConfig(PVJBlocks.jungle_twigs.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig darkOakTwigsCluster = createGroundcoverConfig(PVJBlocks.dark_oak_twigs.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig acaciaTwigsCluster = createGroundcoverConfig(PVJBlocks.acacia_twigs.getDefaultState(), new GroundcoverPlacer());
		
		BlockClusterFeatureConfig oakFallenLeavesCluster = createGroundcoverConfig(PVJBlocks.oak_fallen_leaves.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig birchFallenLeavesCluster = createGroundcoverConfig(PVJBlocks.birch_fallen_leaves.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig spruceFallenLeavesCluster = createGroundcoverConfig(PVJBlocks.spruce_fallen_leaves.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig jungleFallenLeavesCluster = createGroundcoverConfig(PVJBlocks.jungle_fallen_leaves.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig darkOakFallenLeavesCluster = createGroundcoverConfig(PVJBlocks.dark_oak_fallen_leaves.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig acaciaFallenLeavesCluster = createGroundcoverConfig(PVJBlocks.acacia_fallen_leaves.getDefaultState(), new GroundcoverPlacer());
		
		BlockClusterFeatureConfig rocksCluster = createGroundcoverConfig(PVJBlocks.rocks.getDefaultState(), new RocksPlacer());
		BlockClusterFeatureConfig sandstoneRocksCluster = createGroundcoverConfig(PVJBlocks.sandstone_rocks.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig redSandstoneRocksCluster = createGroundcoverConfig(PVJBlocks.red_sandstone_rocks.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig iceChunks = createGroundcoverConfig(PVJBlocks.ice_chunks.getDefaultState(), new GroundcoverPlacer());
		
		BlockClusterFeatureConfig bonesCluster = createGroundcoverConfig(PVJBlocks.bones.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig bonesNetherCluster = createNetherGroundcoverConfig(PVJBlocks.bones.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig charredBonesNetherCluster = createNetherGroundcoverConfig(PVJBlocks.charred_bones.getDefaultState(), new GroundcoverPlacer());
		
		BlockClusterFeatureConfig pineconesCluster = createGroundcoverConfig(PVJBlocks.pinecones.getDefaultState(), new GroundcoverPlacer());
		BlockClusterFeatureConfig seashellsCluster = createGroundcoverConfig(PVJBlocks.seashells.getDefaultState(), new GroundcoverPlacer());
	...
	private static BlockClusterFeatureConfig createGroundcoverConfig(BlockState state, BlockPlacer placer) {
		return new BlockClusterFeatureConfig
				.Builder(new SimpleBlockStateProvider(state), placer)
				.func_227315_a_(4)
				.func_227322_d_();
	}
	
	private static BlockClusterFeatureConfig createNetherGroundcoverConfig(BlockState state, BlockPlacer placer) {
		return new BlockClusterFeatureConfig
				.Builder(new SimpleBlockStateProvider(state), placer)
				.func_227315_a_(64)
				.func_227317_b_()

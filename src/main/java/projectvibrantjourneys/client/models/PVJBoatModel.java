...
@OnlyIn(Dist.CLIENT)
public class PVJBoatModel extends SegmentedModel<PVJBoatEntity> {
   ...
   @Override
   public void setRotationAngles(PVJBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   protected void func_228244_a_(PVJBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {

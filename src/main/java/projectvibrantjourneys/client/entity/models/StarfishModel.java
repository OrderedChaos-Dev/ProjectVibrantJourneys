...
public class StarfishModel<T extends Entity> extends SegmentedModel<T> {
    ...
    public StarfishModel()
    {
        ...
        this.body2.setPos(0.0F, 22.899999618530273F, -0.30000001192092896F);
        this.body2.addBox(-0.5F, 0.0F, -3.9000000953674316F, 1, 1, 4, 0.0F);
        this.setRotateAngle(body2, 0.0F, -2.2764329910278316F, 0.0F);
        this.body3 = new ModelRenderer(this, 0, 0);
        this.body3.setPos(0.0F, 22.899999618530273F, -0.20000000298023224F);
        ...
        this.body1.setPos(0.0F, 22.899999618530273F, -0.20000000298023224F);
        ...
        this.body5.setPos(0.9F, 22.9F, -0.1F);
        ...
        this.body4.setPos(0.0F, 22.899999618530273F, -0.20000000298023224F);

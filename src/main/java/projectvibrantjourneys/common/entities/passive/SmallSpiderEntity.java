...
public class SmallSpiderEntity extends CreatureEntity {
	
	private static final DataParameter<Byte> CLIMBING = EntityDataManager.createKey(SmallSpiderEntity.class, DataSerializers.BYTE);
	
	public SmallSpiderEntity(EntityType<? extends SmallSpiderEntity> type, World world) {
		super(type, world);
	}

...
public class SnailEntity extends CreatureEntity {
	...
	private static final DataParameter<Integer> COLOR = EntityDataManager.<Integer>createKey(SnailEntity.class, DataSerializers.VARINT);
	private static final DataParameter<Byte> CLIMBING = EntityDataManager.createKey(SnailEntity.class, DataSerializers.BYTE);

package projectvibrantjourneys.common.entities.item;
...
public class PVJBoatEntity extends BoatEntity {
   private static final DataParameter<Integer> PVJ_TIME_SINCE_HIT = EntityDataManager.createKey(PVJBoatEntity.class, DataSerializers.VARINT);
   private static final DataParameter<Integer> PVJ_FORWARD_DIRECTION = EntityDataManager.createKey(PVJBoatEntity.class, DataSerializers.VARINT);
   private static final DataParameter<Float> PVJ_DAMAGE_TAKEN = EntityDataManager.createKey(PVJBoatEntity.class, DataSerializers.FLOAT);
   private static final DataParameter<Integer> PVJ_BOAT_TYPE = EntityDataManager.createKey(PVJBoatEntity.class, DataSerializers.VARINT);
   private static final DataParameter<Boolean> PVJ_field_199704_e = EntityDataManager.createKey(PVJBoatEntity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Boolean> PVJ_field_199705_f = EntityDataManager.createKey(PVJBoatEntity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Integer> PVJ_ROCKING_TICKS = EntityDataManager.createKey(PVJBoatEntity.class, DataSerializers.VARINT);
   ...
   public PVJBoatEntity(EntityType<? extends PVJBoatEntity> entity, World world) {
      super(entity, world);	
   ...
   protected void registerData() {
      this.dataManager.register(PVJ_TIME_SINCE_HIT, 0);
      this.dataManager.register(PVJ_FORWARD_DIRECTION, 1);
      this.dataManager.register(PVJ_DAMAGE_TAKEN, 0.0F);
      this.dataManager.register(PVJ_BOAT_TYPE, PVJBoatEntity.Type.FIR.ordinal());
      this.dataManager.register(PVJ_field_199704_e, false);
      this.dataManager.register(PVJ_field_199705_f, false);
      this.dataManager.register(PVJ_ROCKING_TICKS, 0);
   }
   ...
   public void tick() {
      ...
      this.status = this.getBoatStatusPVJ();
      ...
      //aka super.super.tick();
      //super.tick(); will crash due to accessing null data from parent BoatEntity
      if (!this.world.isRemote) {
   ...
   public void setPaddleState(boolean left, boolean right) {
      this.dataManager.set(PVJ_field_199704_e, left);
      this.dataManager.set(PVJ_field_199705_f, right);
   }
   ...
   private BoatEntity.Status getBoatStatusPVJ() {
   ...
   protected void readAdditional(CompoundNBT compound) {
      if (compound.contains("Type", 8)) {
         this.setBoat(PVJBoatEntity.Type.getTypeFromString(compound.getString("Type")));
      }
            ...
            if (this.fallDistance > 3.0F) {
               ...
               if (!this.world.isRemote && !this.removed) {
                  ...
                  if (this.world.getGameRules().getBoolean(GameRules.DO_ENTITY_DROPS)) {
                     for(int i = 0; i < 3; ++i) {
                        this.entityDropItem(this.getBoat().asPlank());
                     }
   ...
   public boolean getPaddleState(int side) {
      return this.dataManager.<Boolean>get(side == 0 ? PVJ_field_199704_e : PVJ_field_199705_f) && this.getControllingPassenger() != null;
   }

   @Override
   public void setDamageTaken(float damageTaken) {
      this.dataManager.set(PVJ_DAMAGE_TAKEN, damageTaken);
   }

   @Override
   public float getDamageTaken() {
      return this.dataManager.get(PVJ_DAMAGE_TAKEN);
   }

   @Override
   public void setTimeSinceHit(int timeSinceHit) {
      this.dataManager.set(PVJ_TIME_SINCE_HIT, timeSinceHit);
   }

   @Override
   public int getTimeSinceHit() {
      return this.dataManager.get(PVJ_TIME_SINCE_HIT);
   }

   private void setRockingTicks(int p_203055_1_) {
      this.dataManager.set(PVJ_ROCKING_TICKS, p_203055_1_);
   }

   private int getRockingTicks() {
      return this.dataManager.get(PVJ_ROCKING_TICKS);
   }
   ...
   public void setForwardDirection(int forwardDirection) {
      this.dataManager.set(PVJ_FORWARD_DIRECTION, forwardDirection);
   }

   @Override
   public int getForwardDirection() {
      return this.dataManager.get(PVJ_FORWARD_DIRECTION);
   }

   public void setBoat(PVJBoatEntity.Type boatType) {
      this.dataManager.set(PVJ_BOAT_TYPE, boatType.ordinal());
   }

   
   public PVJBoatEntity.Type getBoat() {
      return PVJBoatEntity.Type.byId(this.dataManager.get(PVJ_BOAT_TYPE));
   }
   ...
   public static enum Type {
	  ...
	  JUNIPER(PVJBlocks.juniper_planks, "junipers");
       ...
       */
      public static PVJBoatEntity.Type byId(int id) {
         PVJBoatEntity.Type[] aboatentity$type = values();
      ...
      public static PVJBoatEntity.Type getTypeFromString(String nameIn) {
         PVJBoatEntity.Type[] aboatentity$type = values();

...
public class PVJBoatItem extends Item {
   ...
   private final PVJBoatEntity.Type type;

   public PVJBoatItem(PVJBoatEntity.Type typeIn, Item.Properties properties) {
      super(properties);
      this.type = typeIn;
   }
   ...
   public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
      ...
      if (raytraceresult.getType() == RayTraceResult.Type.MISS) {
         ...
         if (raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
            PVJBoatEntity boatentity = new PVJBoatEntity(worldIn, raytraceresult.getHitVec().x, raytraceresult.getHitVec().y, raytraceresult.getHitVec().z);

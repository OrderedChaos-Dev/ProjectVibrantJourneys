...
public final class RedwoodPeaksBiome extends Biome {
	public RedwoodPeaksBiome() {
		super((new Biome.Builder()).surfaceBuilder(PVJBiomes.REDWOODS_SB, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)

...
public class CottonwoodTreeFeature extends AbstractTreeFeature<TreeFeatureConfig> {
   public CottonwoodTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225803_1_) {
      super(p_i225803_1_);
   }

   private void func_227233_a_(IWorldGenerationReader world, Random rand, BlockPos pos, float f, Set<BlockPos> leaves, MutableBoundingBox box, TreeFeatureConfig config) {
   ...
   private void func_227232_a_(IWorldGenerationReader p_227232_1_, Random p_227232_2_, int p_227232_3_, BlockPos p_227232_4_, List<CottonwoodTreeFeature.ExtendedPos> p_227232_5_, Set<BlockPos> p_227232_6_, MutableBoundingBox p_227232_7_, TreeFeatureConfig p_227232_8_) {
      for(CottonwoodTreeFeature.ExtendedPos fancytreefeature$extendedpos : p_227232_5_) {
   ...
   private void func_227240_b_(IWorldGenerationReader p_227240_1_, Random p_227240_2_, int p_227240_3_, BlockPos p_227240_4_, List<CottonwoodTreeFeature.ExtendedPos> p_227240_5_, Set<BlockPos> p_227240_6_, MutableBoundingBox p_227240_7_, TreeFeatureConfig p_227240_8_) {
      for(CottonwoodTreeFeature.ExtendedPos fancytreefeature$extendedpos : p_227240_5_) {
   ...
   public boolean func_225557_a_(IWorldGenerationReader p_225557_1_, Random p_225557_2_, BlockPos p_225557_3_, Set<BlockPos> p_225557_4_, Set<BlockPos> p_225557_5_, MutableBoundingBox p_225557_6_, TreeFeatureConfig p_225557_7_) {
      ...
      if (i == -1) {
         ...
         this.setDirtAt(p_225557_1_, p_225557_3_.down(), p_225557_3_);
         ...
         int i1 = i - 5;
         List<CottonwoodTreeFeature.ExtendedPos> list = Lists.newArrayList();
         list.add(new CottonwoodTreeFeature.ExtendedPos(p_225557_3_.up(i1), l));
               ...
               for(int j1 = 0; j1 < k; ++j1) {
                  ...
                  if (this.func_227235_a_(p_225557_1_, p_225557_2_, blockpos, blockpos1, false, p_225557_4_, p_225557_6_, p_225557_7_) == -1) {
                     ...
                     if (this.func_227235_a_(p_225557_1_, p_225557_2_, blockpos2, blockpos, false, p_225557_4_, p_225557_6_, p_225557_7_) == -1) {
                        list.add(new CottonwoodTreeFeature.ExtendedPos(blockpos, blockpos2.getY()));
                     }
                  }
               }
            }
   ...
   private int func_227241_b_(IWorldGenerationReader p_227241_1_, Random p_227241_2_, BlockPos p_227241_3_, int p_227241_4_, Set<BlockPos> p_227241_5_, MutableBoundingBox p_227241_6_, TreeFeatureConfig p_227241_7_) {
      if (!isSoilOrFarm(p_227241_1_, p_227241_3_.down(), (IPlantable) PVJBlocks.cottonwood_sapling)) {
         return -1;
      } else {
